...
#define IS_CONSUMER_KEYCODE(code) ((code) >= KC_AUDIO_MUTE && (code) <= KC_SCREEN_LOCK)
...
#define CONSUMER_KEYCODE_RANGE              KC_AUDIO_MUTE ... KC_SCREEN_LOCK
